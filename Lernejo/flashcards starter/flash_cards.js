var kartoj = [{demando: "Input Device", respondo: "In computing, an input device is a piece of computer hardware equipment used to provide data and control signals to an information processing system such as a computer or information appliance. Examples of input devices include keyboards, mouse, scanners, digital cameras and joysticks."},
	      ...
	      {demando: "Function", respondo: "In computer programming, a <b>subroutine</b> is a sequence of program instructions that perform a specific task, packaged as a unit. This unit can then be used in programs wherever that particular task should be performed.<br/>
<br/>
...
Today, the most commonly used notation for this basic operation has come to be <code><i>x</i> = <i>expr</i></code> (originally Superplan 1949–51, popularized by Fortran 1957 and C) followed by <code><i>x</i> := <i>expr</i></code> (originally ALGOL 1958, popularised by Pascal), although there are many other notations in use. In some languages the symbol used is regarded as an <b>operator</b> (meaning that the assignment has a value) while others define the assignment as a <b>statement</b> (meaning that it cannot be used in an expression)."},
	      ...
	      {demando: "Object", respondo: "In computer science, an <b>object</b> can be a variable, a data structure, a function, or a method, and as such, is a location in memory having a value and referenced by an identifier.<br/>
<br/>
In the class-based object-oriented programming paradigm, \"object\" refers to a particular instance of a class where the object can be a combination of variables, functions, and data structures.<br/>
<br/>
In relational database management, an object can be a table or column, or an association between data and a database entity (such as relating a person's age to a specific person).omputer hardware or software that accesses a service made available by a server."},

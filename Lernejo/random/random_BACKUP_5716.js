...
<<<<<<< HEAD
    ...
    cy1 = Math.random()*100;
    r1 = Math.random()*50;
    circolor1 = createColor();
    cx2 = Math.random()*200;
    cy2 = Math.random()*100;
    r2 = Math.random()*50;
    circolor2 = createColor();
    circle1 = makeCircle(cx1,cy1, r1, circolor1);
    var animateCircle1=document.createElementNS(namespace, "animate")
    animateCircle1.setAttribute("keySplines",".5 0 .5 1")
    animateCircle1.setAttribute
    circle1.appendChild(animateCircle1)
    var rectWidth = Math.random()*100;
    var rectHeight = Math.random()*100;
    rectangle = makeRect(Math.random()*200-rectWidth,Math.random()*100-rectHeight, rectWidth, rectHeight, createColor());
    var pathc = createColor()
    triangle = makePath("M " + Math.random()*200 + " " + Math.random()*100 + " l "+((Math.random()*200)-100) + " "+((Math.random()*200)-100) + " l "+((Math.random()*200)-100) + " "+((Math.random()*200)-100) + " C",pathc,pathc);
=======
...
>>>>>>> 045fc15718911797ae35408a58169c8024827d65
}
